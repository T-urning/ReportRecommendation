...
class BertForTM(BertPreTrainedModel):
...
class BertForKE(BertPreTrainedModel):
    _keys_to_ignore_on_load_unexpected = [r"pooler"]
...
class BertCrfWithContraintForKE(BertPreTrainedModel):
    _keys_to_ignore_on_load_unexpected = [r"pooler"]
...
class BertCrfForKE(BertPreTrainedModel):
    _keys_to_ignore_on_load_unexpected = [r"pooler"]
